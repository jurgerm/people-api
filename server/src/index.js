...
import nd14Router from "./routes/nd-14.js";
import nd1617Router from "./routes/nd-16-17.js";
import nd19Router from "./routes/nd-19.js";
...
const main = async () => {
    ...
    try {
        ...
        // router for nd-14
        app.use("/nd-14", nd14Router);

        // router for nd-16-17
        app.use("/nd-16-17", nd1617Router);
